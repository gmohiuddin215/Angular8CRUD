	...
	$(document).ready(function() {
		...
		function AdjustHeader(){
		  if ($(window).scrollTop() > 40) {
			document.getElementById("top-menu").style.backgroundColor = "white";
			document.getElementById("top-menu").style.opacity = "0.8";
			...
			document.getElementById("top-menu").style.opacity = "";
		  }
		}
	  });
